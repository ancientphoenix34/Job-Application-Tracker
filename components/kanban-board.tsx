...
import { Award, Calendar, CheckCircle2, Columns, Dice1, Mic, MoreVertical, Trash2, XCircle } from "lucide-react";
...
function DroppableColumn(
    ...
    const sortedjJobs=column.jobApplications?.sort((a,b)=>a.order-b.order) || [];
...
return <Card className="min-w-[300px] flex-shrink-0 shadow-md p-0">
    ...
    {
        sortedjJobs.map((job,key)=>{
            return <SortableJobCard key={key} job={{...job, columnId: job.columnId || column._id}} columns={sortedColumns}/>;
        })
    }
